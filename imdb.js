...
function create_and_append(category, title, id, date, path) {
    ...
    list.innerHTML = ` 
     <div class="image"><a href="movie page.html?${id}" ><img data-id="${id}" src="${api_img + path}"></a></div>
...
async function create_and_append_list(pass, element) {
    ...
    child.innerHTML = `
                 ...
                 <a href="movie page.html?${result.id}" ><img data-id="${result.id}" src="${api_img + result.poster_path}"></a></div>
